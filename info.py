...
BOT_TOKEN = environ.get('BOT_TOKEN', "7916792832:AAHkEweRBylSJAnaKg54mCojhNpYmf9KTtU")
BOT_USERNAME = environ.get("BOT_USERNAME", 'YABOTZ_FILESTORE_BOT') # without @ 

# Admins, Channels & Users
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1002552822897')) # admin your channel in stream 
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002552822897')) # admin your channel in users log 
...
AUTH_CHANNEL = (environ.get("AUTH_CHANNEL", "-1002552822897"))
